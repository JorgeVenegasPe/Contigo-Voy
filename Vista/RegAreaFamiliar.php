                ...
                <div class="checkout-information">
                  <div class="input-group2">
                    <div class="input-group">
                      ...
                      <input id="CantHijos" type="number" name="CantHijos" class="input" min="0" pattern="^[0-9]+" required />
                    </div>
                    <div class="input-group">
                      <h3 for="CantHermanos">Cantidad de Hermanos</h3>
                      <input id="CantHermanos" type="number" name="CantHermanos" class="input" min="0" pattern="^[0-9]+" required />
                    </div>
                  </div>
                  <div class="input-group">
