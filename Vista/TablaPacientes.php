            ...
            <div class="container-paciente-tabla">
                ...
                ?>
                    ...
                    <tbody id="myTable" class="tu-tbody-clase">
                        <tr>
                            <td>
                                <input type="checkbox" class="checkbox" id="checkbox<?=$patient[0]?>"
                                    value="<?=$patient[0]?>">
                            </td>
                            ...
                            <td class="additional-column"
                                style="font-weight:bold;width:25%;text-align: start; margin-left:4%; padding-left: 3%;">
                                <?=$patient['Email']?></td>
                            <td class="additional-column" style="font-weight:bold;"><?=$patient['Telefono']?></td>
                            <td class="additional-column">
                                <div style="display: flex;justify-content: center;margin-top: 2%;">
                                    <a class="buttoncita" style="width: 110px; padding:6px; font-size:10px;"
                                        href="RegCitas.php">
                                        <span class="material-symbols-sharp">add</span>Crear Cita
                                    </a>
                                </div>
    ...
    <div id="modalEliminar<?=$patient[0]?>" class="service-modal flex-center">
        <div class="service-modal-body">
            ...
            <div class="modal-button-container">
                <a href="../Crud/Paciente/eliminarPaciente.php?id=<?=$patient[0]?>"
                    class="button-modal button-delete">Eliminar</a>
            </div>
        </div>
    </div>
    <!-- Modal de edicion -->
                ...
                <form action="../Crud/Paciente/modificarPaciente.php" method="POST" class="modifica-form">
                    ...
                    <div class="input-group2">
                        <div style=" width:190px;" class="input-group-modal">
                            ...
                            <input type="date" id="FechaNacimiento" value="<?=$patient[6]?>" name="FechaNacimiento"
                                max="<?= $fechamin ?>" value="<?= $fechamin ?>" onchange="calcularEdad()" />
                        </div>
                        <div class="input-group-modal">
                            <h3 for="Edad">Edad</h3>
                    ...
                    <div class="input-group2">
                        <div style="width:190px" class="input-group-modal">
                            ...
                            <select style="text-align:center" class="input" id="EstadoCivil" name="EstadoCivil"
                                required>
                                ...
                                <option value="divorciado"
                                    <?php echo ($patient[10] === 'divorciado') ? 'selected' : ''; ?>>Divorciado/a
                                </option>
                        ...
                        <div style=" width:190px;" class="input-group-modal">
                            ...
                            <select style="text-align:center" class="input" id="Genero" name="Genero" required>
                                ...
                                <option value="Masculino"
                                    <?php echo ($patient[11] === 'Masculino') ? 'selected' : ''; ?>>Masculino</option>
                    ...
                    <div class="input-group-modal">
                        ...
                        <input type="text" id="AntecedentesMedicos" value="<?=$patient[15]?>" class="input"
                            name="AntecedentesMedicos" style="color: #7B7C89;" required />
                    </div>
                    <div class="input-group-modal">
                        ...
                        <input type="text" id="MedicamentosPrescritos" class="input" value="<?=$patient[17]?>"
                            name="MedicamentosPrescritos" style="color: #7B7C89;" required />
                    </div>
                    <div class="input-group-modal" style="display: none">
                        <h3 for="IdPsicologo">IdPsicologo</h3>
